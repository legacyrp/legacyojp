...
int WeaponReadyAnim[WP_NUM_WEAPONS] =
{
	...
	BOTH_WALK1,//WP_MELEE, was TORSO_WEAPONREADY3, I know it's hackish but it works for now until it's dealt with
	...
	TORSO_WEAPONREADY10,//TORSO_WEAPONREADY11,//WP_GRENADE,
...
int WeaponReadyLegsAnim[WP_NUM_WEAPONS] =
{
	...
	BOTH_STAND1,//TORSO_WEAPONREADY11,//WP_GRENADE,
...
/* sounds */ "",
...

	{
		"weapon_tusken_rifle",
		"sound/weapons/w_pkup.wav",
        { "models/weapons2/tusken_rifle/tusken_rifle_w.glm", 
		0, 0, 0},
		"models/weapons2/tusken_rifle/tusken_rifle.md3", //view
 		"gfx/hud/w_icon_disruptor",// icon
		100,
		IT_WEAPON,
		WP_TUSKEN_RIFLE,
	...
	case IT_WEAPON:
		...
		if ( gametype == GT_SINGLE_PLAYER ) {
			...
			if (COM_BitCheck(&ps->stats[STAT_WEAPONS], item->giTag) && ps->ammo[ammoIndex] >= ammoData[ammoIndex].max &&
				item->giTag != WP_THERMAL && item->giTag != WP_GRENADE && item->giTag != WP_DET_PACK)
		...
		//[/CoOp]
		if (item->giTag == WP_THERMAL || item->giTag == WP_GRENADE || item->giTag == WP_DET_PACK)
