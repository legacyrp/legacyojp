...
char *forceHolocronModels[] = {
	...
	"models/map_objects/mp/lt_telepathy.md3",	//FP_MINDTRICK,
	...
	"models/map_objects/mp/lt_protect.md3",		//FP_MANIPULATE,
	"models/map_objects/mp/lt_absorb.md3",		//FP_ABSORB,
	"models/map_objects/mp/lt_healother.md3",	//FP_TEAM_HEAL,
	"models/map_objects/mp/dk_powerother.md3",	//FP_LIFT,
...
*/
	...
	else if (cent->currentState.eType == ET_BODY)
	{
		...
		{
			int lightSide = cent->teamPowerType;
	...
	if ( cent->currentState.time == -1 && cent->currentState.weapon == WP_GRENADE && (cent->currentState.eFlags & EF_FIRING) )
