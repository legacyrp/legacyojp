...
static cvarTable_t		gameCvarTable[] = {
	...
	//[SaberSys]
	{ &g_saberanimspeed, "g_saberanimspeed", "1.075", CVAR_SERVERINFO | CVAR_ARCHIVE | CVAR_SYSTEMINFO, 0, qtrue  },
	//[/SaberSys]
	...
	{ &g_speed, "g_speed", "203", CVAR_CHEAT, 0, qtrue  },
...
//	{ &g_blueteam, "g_blueteam", "Rebellion", CVAR_ARCHIVE | CVAR_SERVERINFO | CVAR_USERINFO , 0, qtrue, qtrue  },
	...
	//[Grapple]
	{ &mod_grapple, "mod_grapple", "1", CVAR_ARCHIVE, 0, qtrue },
	...
	{ &g_saberDmgDelay_Idle, "g_saberDmgDelay_Idle", "5000", CVAR_ARCHIVE, 0, qtrue  },
	//[SaberSys]
...
//	Com_Printf ("-----------------------------------\n");
	...
	//[RawMapName]
	navCalculatePaths	= (qboolean)( trap_Nav_Load( level.rawmapname, ckSum.integer ) == qfalse );
...
extern qboolean DuelLimitHit(void);
extern void DuelResetWinsLosses(void);
extern void RemoveDuelDrawLoser(void);
...
extern void G_RemoveDuelist(int team);
